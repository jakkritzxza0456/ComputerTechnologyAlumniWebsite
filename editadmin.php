<?php 
    ...
    if (isset($_GET['delete'])) {
        ...
        $deletestmt = $conn->query("DELETE FROM usersfew WHERE id = $delete_id");
        $deletestmt->execute();

        if ($deletestmt) {
            echo "<script>alert('Data has been deleted successfully');</script>";
            $_SESSION['success'] = "Data has been deleted succesfully";
            header("refresh:1; url=editadmin.php");
        }
                        ...
                        <div class="container mt-4">
                            ...
                            <thead>
                                ...
                                <?php
                                    ...
                                    $stmt = $conn->query("SELECT * FROM usersfew");
                                    $stmt->execute();
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="editadmins.php?id=<?php echo $user['id']; ?>" class="btn btn-warning">Edit</a>
                                        <a onclick="return confirm('Are you sure you want to delete?');" href="?delete=<?php echo $user['id']; ?>" class="btn btn-danger">Delete</a></td>
